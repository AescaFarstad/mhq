 ...
 */
export const welcomeUISync: MinigameUISyncFn = (
    gameState: GameState
): void => {
    const logicState = gameState.activeMinigame?.state as WelcomeState | undefined;
    // Ensure UIMinigameState is also typed as WelcomeState or has a compatible structure
    const uiState = gameState.uiState.activeMinigameState as WelcomeState | undefined;
