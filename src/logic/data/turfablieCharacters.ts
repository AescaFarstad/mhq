...
const charactersData: CharacterData = {
  "ingress_turfablie_scholarly_investigator": {
    ...
    initialLevel: 1,
    baseUpkeep: 0.0,
    bio: "Master diviner Theronin is permanently temporally confused. He speaks of ancient mages as if they'll arrive tomorrow, and greets visitors as old friends, wishing them to be born soon. However knowledgeable he is, it takes, perhaps, a dedicated researcher to extract useful knowledge from a conversation with him.",
  ...
  "ingress_turfablie_silver_tongue": {
    ...
    initialLevel: 1,
    baseUpkeep: 0.0,
    bio: "Forging smiles rather than documents, Elariette conspired her way to 'temporary custodianship' of a failing Mages Guild, relying on Merchant Plaza's elite to build the web of proxy signatures. They took the guild's treasure, and it is little consolation that her authority is no longer on loan. Although... should she just roll with being a guild headmaster? Would it be too late to switch careers at 20?",
