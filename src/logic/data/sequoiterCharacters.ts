...
const charactersData: CharacterData = {
  ...
  "ingress_sequoiter_life_pharmacist": {
    ...
    initialLevel: 1,
    baseUpkeep: 0.0,
    bio: "Siliana started out as an expedition medic, but soon got captured by a tribal cohort. Being a slave doctor, you don't get to chose how to mis-treat your patients. Nor can you look away from agonizing deaths. These memories are better left frozen, but the experience was invaluable for when Siliana escaped. Now she is converting an abandoned guild hall into a makeshift sanctuary where she can practice healing on her own terms.",
  ...
  "ingress_sequoiter_rune_enchanter": {
    ...
    initialLevel: 1,
    baseUpkeep: 0.0,
    bio: "Astartia dreaded mundane work. When she learned of 'Mammoth Prize'—a fortune promised to whoever breaks the runic lock on the eponymous Mages Guild—she moved to Sequoiter and consumed herself with this ancient puzzle. The prize was not adjusted for inflation, so when she triumphed many years later, she only crafted a personal key. She was denied the prize, but they were denied the building. And that lock grows harder by the day...",
