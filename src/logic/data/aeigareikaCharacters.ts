...
const charactersData: CharacterData = {
  ...
  "ingress_aeiga_reika_geomancer_engineer": {
    ...
    initialLevel: 1,
    baseUpkeep: 0.0,
    bio: "Vane traced impossible pressure readings through Aeiga-Reika's tunnels until he exposed the truth: the four Zig Manufactories concealed an ancient Mages Guild at their center, its elemental chambers repurposed into blast furnaces and laminar flow generators. By doctoring development schemas, he methodically untangled the web of pipes and carved his way to the Guild's untouched heart—now his secret abode. It's his turn to cannibalize his surroundings.",
  ...
  "ingress_aeiga_reika_life_artisan": {
    ...
    initialLevel: 1,
    baseUpkeep: 0.0,
    bio: "Few artists are as valued by industry as Meadowlight. Her copper flowers bleeding oily chemicals unnerve before they enchant. Yet, what she is undoubtedly great at is turning mounds of pollution into harmless installations. Soot turns pretty when crystalized. Resin foam is best when spun into a wreath (mind the rusty spikes). Miraculously, her art weighs far less than the waste that arrives at her workshop daily.",
