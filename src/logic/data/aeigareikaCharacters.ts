...
const charactersData: CharacterData = {
  "ingress_aeiga_reika_secret_seer": {
    ...
    initialLevel: 1,
    baseUpkeep: 0.0,
    bio: "Seraphina once brokered secrets for Aeiga-Reika's most powerful—a key player in the sulfur conspiracy. For her services she asked as many coins as she was willing to put on her tongue, where she purified them from the suffering the metal had witnessed. Until her tongue was gnawed all the way through. These days her Crystalline Parlor is closed. She reads the future still, but tells no one.",
  ...
  "ingress_aeiga_reika_nature_healer": {
    ...
    initialLevel: 1,
    baseUpkeep: 0.0,
    bio: "When Coroner Pine Veridis escaped the guild's laboratory, only Gulder dared to approach. Rather than eradicate the plant, he protects it from the waves of Silica-Maw larvae, which the city council has been sending in ever since. Gulder's magic accelerates the grubs' lifecycle and the majority turn into butterflies just before reaching the target.",
  ...
  "ingress_aeiga_reika_chaos_artificer": {
    ...
    initialLevel: 1,
    baseUpkeep: 0.0,
    bio: "Lyra had been working at the Grand Assembly Hall since she was ten. They were happy to have someone who could climb inside the titan's hand to fine-tune the digits. But things around her came apart more often than they'd come together as Lyra's true passion was dismantling complex apparatus. When the Highlander Mages Collective fled from Aeiga-Reika due to labor riots, Lyra undid their locks and turned their office into an automaton graveyard.",
  ...
  "ingress_aeiga_reika_geomancer_engineer": {
    ...
    initialLevel: 1,
    baseUpkeep: 0.0,
    bio: "Vane traced impossible pressure readings through Aeiga-Reika's tunnels until he exposed the truth: the four Zig Manufactories concealed an ancient Mages Guild at their center, its elemental chambers repurposed into blast furnaces and laminar flow generators. By doctoring development schemas, he methodically untangled the web of pipes and carved his way to the Guild's untouched heart—now his secret abode. It's his turn to cannibalize the surroundings.",
  ...
  "ingress_aeiga_reika_grim_fighter": {
    ...
    initialLevel: 1,
    baseUpkeep: 0.0,
    bio: "Marcaedro once shattered a golem's head with his bare fist—50% luck, 50% pain, and the crowd still remembers his name. Betting lost him a fortune, so he pivoted to organizing tournaments. While excavating space for an arena beneath the Under Galleries, his crew broke into a Mages Guild that had catastrophically sunk. Marcaedro dismissed the workers, added hidden entrances, and now uses it as refuge from creditors.",
  ...
  "ingress_aeiga_reika_life_artisan": {
    ...
    initialLevel: 1,
    baseUpkeep: 0.0,
    bio: "Few artists are as valued by industry as Meadowlight. Her copper flowers bleeding oily chemicals unnerve before they enchant. Yet, they are undoubtedly the superior form of the pollution mounds they would have otherwise been. Soot turns pretty when crystalized. Resin foam is best when spun into a wreath (mind the rusty spikes). Miraculously, her art weighs far less than the waste that arrives at her workshop daily. The mayor lets her nowhere near the prison.",
