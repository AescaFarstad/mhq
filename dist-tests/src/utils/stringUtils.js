 ...
 */
export function obfuscateString(text, obfuscationPercentage = 1, progressivity = 0) {
    if (!text) {
        return "";
    }
    ...
    for (let i = 0; i < len; i++) {
        ...
        const originalCharCode = text.charCodeAt(i) || 1;
...
export function wordify(inputText) {
...
export function areOneEditAway(s1, s2) {
