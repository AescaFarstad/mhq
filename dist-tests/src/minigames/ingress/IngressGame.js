import { INGRESS_TYPE } from './IngressTypes';
...
export class IngressGame {
     ...
     */
    processSubmittedWord(word, ingressWordsLib, gameState) {
    ...
    exploreCharacter(characterId, gameState) {
    ...
    updateCharacterUnlocks(gameState) {
    ...
    getExplorationCost(characterOption) {
        switch (characterOption.discoveryState) {
            case 'unexplored':
