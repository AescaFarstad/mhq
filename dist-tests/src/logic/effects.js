...
export function giveResource(state, params) {
...
export function giveMaxResource(state, params) {
...
export function addResourceIncome(state, params) {
    const res = getResource(state.resources, params.resource);
    if (res) {
...
export function giveAllSkillsAndSpecsEffect(state, context) {
    ...
    const character = context; // context is expected to be Character here
    const allSkillDefs = state.lib.skills.getAllSkills();
...
export function giveSkillsAndSpecs(state, _params, _context) {
...
export function construct(state, params) {
    if (params.building) {
...
export function startMinigame(state, params) {
    ...
    if (params.name === 'ClickCounter') {
        ...
        const clicksToWin = params.minigameParams?.clicksToWin;
...
export function startBehTree(state, params) {
...
export function applyIngressResults(state, params) {
...
export function applyWelcomeResults(state, params) {
...
export function givePoints(state, params) {
    if (!state.characters || state.characters.length === 0) {
